...
const CalculatorApp = () => {
  ...
  const btnClass =
    'h-12 border border-gray-800 bg-[var(--color-surface)]/50 text-[var(--color-blue)] hover:bg-[var(--color-yellow)] hover:text-black font-bold text-lg transition-colors';
  ...
  return (
    <div className="h-full flex flex-col p-4 bg-black">
      <div className="bg-[var(--color-surface)] border border-gray-700 p-4 mb-4 text-right font-mono">
        ...
        <div className="text-3xl text-[var(--color-yellow)] font-bold tracking-widest">
          {display}
        </div>
      </div>
      <div className="grid grid-cols-4 gap-2 flex-1">
        ...
        <button
          ...
          className={`${btnClass} col-span-4 border-[var(--color-red)] text-[var(--color-red)]`}
        >
          CLEAR_MEMORY
        </button>
      </div>
